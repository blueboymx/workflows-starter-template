/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7dedd75f877ffc5d1c78a34b45ce2462)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ShipmentsDO";
	}
	interface Env {
		VISION_MODEL: "@cf/meta/llama-4-scout-17b-16e-instruct";
		TIMEZONE: "America/Mexico_City";
		PDF_PHOTOS_PER_PAGE: "auto";
		SHIPMENTS: DurableObjectNamespace<import("./worker/index").ShipmentsDO>;
		PHOTOS: R2Bucket;
		AI: Ai;
		ASSETS: Fetcher;
		PACKAGE_WORKFLOW: Workflow<Parameters<import("./worker/index").PackageBatchWorkflow['run']>[0]['payload']>;
	}
}
